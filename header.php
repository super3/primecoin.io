...
<head>
    ...
    <meta property="og:description"
          content="A new type cryptocurrency which is proof-of-work based on searching for prime numbers."/>
                    ...
                    <div class="navbar-collapse collapse">
                        ...
                        <div  class="nav-menu pull-right">
                            <ul id="menu" class="nav nav-pills">
                                ...
                                <li><a href="index.php#page2">About</a></li>
                                <li><a href="index.php#how-to-mine">How to Mine</a></li>
                                <li><a href="index.php#page5">Resources</a></li>
